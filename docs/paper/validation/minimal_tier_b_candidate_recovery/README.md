...
This validation package captures a proof-of-feasibility run in which one conservative backbone locus is recovered as a real Tier B candidate sequence from an unannotated assembly and propagated through the existing merge and reporting layers.
...
- original validation manifests: [manifests](/Users/sam/Documents/New%20project/docs/paper/validation/minimal_tier_b_candidate_recovery/manifests)
